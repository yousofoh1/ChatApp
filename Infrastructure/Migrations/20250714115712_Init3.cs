    ...
    public partial class Init3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserFriend", x => new { x.AppUserId, x.FriendId });
                    table.ForeignKey(
                        name: "FK_AppUserFriend_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppUserFriend_AspNetUsers_FriendId",
                        column: x => x.FriendId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserFriend_FriendId",
                table: "AppUserFriend",
                column: "FriendId");
